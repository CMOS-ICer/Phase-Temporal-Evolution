...
{ -11.9,-7 },{ 11.9,7 } },textString = "Integral",fontSize = 20,textStyle = { TextStyle.None },textColor = { 0,0,0 },horizontalAlignment = TextAlignment.Left),Text(origin = { -6,-96 },lineColor = { 0,0,0 },extent = { { -11.9,-7 },{ 11.9,7 } },textString = "Integral",fontSize = 20,textStyle = { TextStyle.None },textColor = { 0,0,0 },horizontalAlignment = TextAlignment.Left),Text(origin = { 44,-72 },lineColor = { 0,0,0 },extent = { { -13.26,-7 },{ 13.26,7 } },textString = "Subtract",fontSize = 20,textStyle = { TextStyle.None },textColor = { 0,0,0 },horizontalAlignment = TextAlignment.Left),Text(origin = { 105,-22 },lineColor = { 0,0,0 },extent = { { -9.86,-7 },{ 9.86,7 } },textString = "Divide",fontSize = 20,textStyle = { TextStyle.None },textColor = { 0,0,0 },horizontalAlignment = TextAlignment.Left)}));
  ...
  SysplorerEmbeddedCoder.Sources.PulseGenerator 'Pulse10Generator6'(pulseType=SysplorerEmbeddedCoder.Sources.PulseGenerator.PulseType.timeBased,amplitude=1,period_time=1/(f),width_time=50,phase_time=0,timeSource=SysplorerEmbeddedCoder.Sources.PulseGenerator.TimeSourceType.simulationTime) 
  ...
  SysplorerEmbeddedCoder.Sources.PulseGenerator 'Pulse10Generator7'(pulseType=SysplorerEmbeddedCoder.Sources.PulseGenerator.PulseType.timeBased,amplitude=1,period_time=1/(f),width_time=50,phase_time=0.5/(f),timeSource=SysplorerEmbeddedCoder.Sources.PulseGenerator.TimeSourceType.simulationTime) 
  ...
  SysplorerEmbeddedCoder.Sources.PulseGenerator 'Pulse10Generator8'(pulseType=SysplorerEmbeddedCoder.Sources.PulseGenerator.PulseType.timeBased,amplitude=1,period_time=1/(f),width_time=50,phase_time=0.75/(f),timeSource=SysplorerEmbeddedCoder.Sources.PulseGenerator.TimeSourceType.simulationTime) 
  ...
  SysplorerEmbeddedCoder.Sources.PulseGenerator 'Pulse10Generator9'(pulseType=SysplorerEmbeddedCoder.Sources.PulseGenerator.PulseType.timeBased,amplitude=1,period_time=1/(f),width_time=50,phase_time=0.25/f,timeSource=SysplorerEmbeddedCoder.Sources.PulseGenerator.TimeSourceType.simulationTime) 
      ...
      class VarData "外部对象类定义"
        ...
        function constructor
          input SysplorerEmbeddedCoder.Types.Auto var_name 
            annotation(Placement(transformation(extent={{-15,448},{15,488}})), __MWORKS(BlockSystem(
        ...
        function destructor
          input VarData obj     annotation(Placement(transformation(extent={{-15,240},{15,280}})));
          annotation(Protection(access=Access.packageDuplicate));
  ...
  extent={{-103,-50.0583},{103,50.0583}})), __MWORKS(ComponentNamePlacement(BOTTOM)));
    ...
    block CCaller
      ...
      output SysplorerEmbeddedCoder.Types.Auto out annotation(Placement(transformation(extent={{-15,32},{15,72}})), __MWORKS(BlockSystem(Type(inherit = InheritType.none, ref="int32"), Dimension(dimensionType = DimensionType.none) = 1)));
  ...
  grid={2,2})),Protection(access=Access.packageDuplicate));
    ...
    inner ExternalObject_T x "外部对象构造组件" annotation(HideResult = true,
      __MWORKS(BlockSystem(Instance(u(u1(Type(inherit=InheritType.none ,ref="string") ,Dimension(dimensionType=DimensionType.none)=1)="Q0_Q180",u2(Type(inherit=InheritType.none ,ref="int32") ,Dimension(dimensionType=DimensionType.none)=1)=size(reshape.y,1),u3(Type(inherit=InheritType.none ,ref="int32") ,Dimension(dimensionType=DimensionType.none)=1)=0,u4(Type(inherit=InheritType.none ,ref="int32") ,Dimension(dimensionType=DimensionType.none)=1)=target_workspace,u5(Type(inherit=InheritType.none ,ref="int32") ,Dimension(dimensionType=DimensionType.none)=1)=max_data_point),y(Type(inherit=InheritType.none ,ref=VarData) ,Dimension(dimensionType=DimensionType.none)=1)))));
  ...
  grid={2,2})),Protection(access=Access.packageDuplicate));
    ...
    inner ExternalObject_T x "外部对象构造组件" annotation(HideResult = true,
      __MWORKS(BlockSystem(Instance(u(u1(Type(inherit=InheritType.none ,ref="string") ,Dimension(dimensionType=DimensionType.none)=1)="Q90_Q270",u2(Type(inherit=InheritType.none ,ref="int32") ,Dimension(dimensionType=DimensionType.none)=1)=size(reshape.y,1),u3(Type(inherit=InheritType.none ,ref="int32") ,Dimension(dimensionType=DimensionType.none)=1)=0,u4(Type(inherit=InheritType.none ,ref="int32") ,Dimension(dimensionType=DimensionType.none)=1)=target_workspace,u5(Type(inherit=InheritType.none ,ref="int32") ,Dimension(dimensionType=DimensionType.none)=1)=max_data_point),y(Type(inherit=InheritType.none ,ref=VarData) ,Dimension(dimensionType=DimensionType.none)=1)))));
