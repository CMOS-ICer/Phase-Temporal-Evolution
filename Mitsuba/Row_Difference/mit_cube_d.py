...
def make_scene(cube_z: float, sphere_z: float) -> mi.Scene:
    ...
    scene_dict = {'type': 'scene', 'integrator': {'type': 'path'}, 'sensor': {'type': 'perspective', 'to_world': mi.ScalarTransform4f.look_at(origin=CAM_ORIGIN, target=CAM_TARGET, up=CAM_UP), 'fov': CAM_FOV, 'film': {'type': 'hdrfilm', 'width': IMG_W, 'height': IMG_H, 'rfilter': {'type': 'tent'}, 'pixel_format': 'rgb'}, 'sampler': {'type': 'multijitter', 'sample_count': SPP}}, 'env_emitter': {'type': 'constant', 'radiance': {'type': 'rgb', 'value': [0.1, 0.1, 0.1]}}, 'wall': {'type': 'rectangle', 'to_world': mi.ScalarTransform4f.translate([0.0, 1.2, wall_z]) @ mi.ScalarTransform4f.rotate([0, 1, 0], 180.0) @ mi.ScalarTransform4f.scale([5.0, 3.0, 1.0]), 'bsdf': {'type': 'roughplastic', 'alpha': 0.65, 'diffuse_reflectance': {'type': 'rgb', 'value': [0.65, 0.64, 0.62]}, 'specular_reflectance': {'type': 'rgb', 'value': [0.01, 0.01, 0.01]}}}, 'ground': {'type': 'rectangle', 'to_world': mi.ScalarTransform4f.translate([0.0, -0.15, 0.0]) @ mi.ScalarTransform4f.rotate([1, 0, 0], -90.0) @ mi.ScalarTransform4f.scale([5.0, 2, 5.0]), 'bsdf': {'type': 'roughplastic', 'alpha': 0.22, 'diffuse_reflectance': {'type': 'rgb', 'value': [0.36, 0.28, 0.22]}, 'specular_reflectance': {'type': 'rgb', 'value': [0.04, 0.04, 0.04]}}}, 'cube': {'type': 'cube', 'to_world': mi.ScalarTransform4f.translate([0, 0, cube_z]) @ mi.ScalarTransform4f.rotate([0, 1, 0], CUBE_ROT_DEG1) @ mi.ScalarTransform4f.scale([CUBE_EDGE / 2.0, CUBE_EDGE / 0.7, CUBE_EDGE / 2.0]), 'bsdf': {'type': 'roughplastic', 'alpha': 0.9, 'diffuse_reflectance': {'type': 'rgb', 'value': [0.95, 0.72, 0.55]}, 'specular_reflectance': {'type': 'rgb', 'value': [0.03, 0.03, 0.03]}}}}
